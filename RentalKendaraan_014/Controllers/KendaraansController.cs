...
using RentalKendaraan_014.Models;

namespace RentalKendaraan_014.Controllers
{
    public class KendaraansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaKendaraan,N0Polisi,N0Stnk,IdJenisKendaraan,Ketersediaan")] Kendaraan kendaraan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKendaraan,NamaKendaraan,N0Polisi,N0Stnk,IdJenisKendaraan,Ketersediaan")] Kendaraan kendaraan)
        {
